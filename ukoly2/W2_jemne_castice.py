...
air_polution_pivot_1 = pandas.pivot_table(air_polution, index="year", columns="month", values="pm25", aggfunc=numpy.mean, margins=False)
...
air_polution_pivot_2 = pandas.pivot_table(air_polution, index="month", columns="dayofweek", values="pm25", aggfunc=numpy.mean, margins=True)
